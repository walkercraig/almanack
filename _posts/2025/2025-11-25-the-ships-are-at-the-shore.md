...
We Americans are not victims. This does not mean surrender. We are not the naïve innocents of some tragic encounter. But we are now the people on the shore that the future has come. From somewhere over the horizon, with its own language, its own expectations, its own technologies, its own rhythm. Our institutions were built for the world behind us, not the one in front of us. And if we insist on defending the continent exactly as it was, we will lose more than we save.
